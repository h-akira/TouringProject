...
> 結論・現状は [README.md](README.md)、手順は [SETUP.md](SETUP.md)、実測は [FINDINGS.md](FINDINGS.md)。
> ここは**「AgentCoreとは何か」と「なぜそう決めたか」**を置く。
>
...
アプリから可変にする要件も満たせる。→ 未検証（[README.md](README.md) の「未検証・残っているもの」）。
